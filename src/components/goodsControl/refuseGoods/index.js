...
class RefuseGoods extends Component {
    constructor(props) {
        super(props);
        this.columns = [
            {
            ...
            },
            {
                ...
                render: (text, record) => {
                    return (
                        ...
                        ? (
                            <div style={{color: 'red'}} onClick={this.handleSeeClick}>修改</div>
                        ) : null
                    );
                },
            }
    ...
    render() {
        ...
        return (
            <div>
                ...
                <OperationWarp>
                    <Button type='primary'>重新申请审核</Button>
                </OperationWarp>
                <Table
...
const mapDispatchToProps = (dispatch) => {
    return {
        updateNavigation() {
            dispatch(actionCreators.updateNav('商品管理', '未通过审核'));
        }
    }
}

export default connect(null, mapDispatchToProps)(RefuseGoods);