            ...
            },
            {
                ...
                render: (text, record) => {
                    return (
                        ...
                        ? (
                            <div style={{color: 'red'}} onClick={this.handleSeeClick}>查看</div>
                        ) : null
                    );
                },
            }
        ...
        return (
            <div>
                ...
                <OperationWarp>
                    ...
                    <Button type='primary'>手动添加商品</Button>
                    <Button type='primary'>申请审核</Button>
                </OperationWarp>
                <Table
...
const mapDispatchToProps = (dispatch) => {
    return {
        updateNavigation() {
            dispatch(actionCreators.updateNav('商品管理', '未上架商品'));
        }
    }
}

export default connect(null, mapDispatchToProps)(NothingSellGoods);